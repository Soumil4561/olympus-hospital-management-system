...
public class AppointmentController implements Initializable {
    ...
    @FXML
    void gotoPatientsTab(MouseEvent event) throws IOException {
        JumpScene.changeScene(patientPane, "UI/patientsTab_receptionist.fxml", event);
    }
    ...
    void displayAppointments() throws SQLException {
        ...
        AppointmentView[] list = getAppointmentInfo.appointmentList( );
